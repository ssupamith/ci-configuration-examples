[![MATLAB](https://github.com/ssupamith/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/ssupamith/ci-configuration-examples/actions/workflows/ci.yml)
